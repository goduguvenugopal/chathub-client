            ...
            <div className='create-custom-group' onClick={() => setModal(true)}>
                ...
                {modal ? <div className='modal-create-custom-group'>
                    ...
                    <div className="card bg-dark text-white">
                        <h5 className="card-header">Create New Group</h5><hr className='m-0 ' />
                            ...
                            <form className='text-dark d-flex flex-column gap-2'  >
                                ...
                                <div className="col">
                                    <input
                                        type="text"
                                        className="form-control"
                                        placeholder="10.Profile Id"
                                        aria-label="First name"
                                    />
                                </div>

                                <button className='btn bg-primary text-white fw-bold'>Create Group</button>
                            </form>
